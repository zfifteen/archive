"""
LIS (Lucas Index System) — Proof of Concept Python wrapper.

Provides simple, batch-oriented helpers you can drop into existing pipelines
to prune candidates before Miller–Rabin and measure a single metric:
MR-call reduction vs a wheel-210 baseline.
"""
...
def build_lis_if_needed() -> None:
    ...
    # Always try to (re)build quietly; no-op if up-to-date
