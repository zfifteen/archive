...
```bash
SHA-256 64-bit State Machine Classifier (All Constants Demo)
=============================================================

=== Baseline: SHA-256 Round Constants (First 8 for Demo) ===
Coverage for Round Constants (K0-K7): 3/8 (37.5%)
8-bit Alignment Pattern for Round Constants: 01000110

Input: 1
Coverage for Hash Values (H0-H7): 1/8 (12.5%)
8-bit Alignment Pattern for Hash Values: 00000010
Classification: Not Aligned
State Transition (Hex): 0x0000000000000000 -> 0x0202020202020202

Input: 11
Coverage for Hash Values (H0-H7): 5/8 (62.5%)
8-bit Alignment Pattern for Hash Values: 01101101
Classification: Aligned
State Transition (Hex): 0x0202020202020202 -> 0x6d6d6d6d6d6d6d6d

Input: 111
Coverage for Hash Values (H0-H7): 5/8 (62.5%)
8-bit Alignment Pattern for Hash Values: 11101001
Classification: Aligned
State Transition (Hex): 0x6d6d6d6d6d6d6d6d -> 0xe9e9e9e9e9e9e9e9

Input: CallMeIshmael
Coverage for Hash Values (H0-H7): 3/8 (37.5%)
8-bit Alignment Pattern for Hash Values: 00111000
Classification: Aligned
State Transition (Hex): 0xe9e9e9e9e9e9e9e9 -> 0x3838383838383838

Input: RandomString
Coverage for Hash Values (H0-H7): 1/8 (12.5%)
8-bit Alignment Pattern for Hash Values: 01000000
Classification: Not Aligned
State Transition (Hex): 0x3838383838383838 -> 0x4040404040404040

=== Conclusion ===
64-bit state machine tracks geometric alignment patterns of SHA-256 outputs tied to seed constants, with demo of round constants.
```
