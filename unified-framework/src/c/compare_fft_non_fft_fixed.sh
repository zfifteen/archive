...
# Save non-FFT binary
cp ./bin/z5d_prime_gen ./bin/z5d_prime_gen_non_fft_temp

 echo "Building FFT-zeta enabled version..."
...
NON_FFT_BINARY="./bin/z5d_prime_gen_non_fft_temp"
