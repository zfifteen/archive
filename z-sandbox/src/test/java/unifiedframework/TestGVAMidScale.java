...
public class TestGVAMidScale {
  ...
  public static Stream<Arguments> provideTargets() {
    try {
      pw = new PrintWriter("output/results/midscale_results.csv");
      pw.println("N_bits,time_sec,success");
      ObjectMapper mapper = new ObjectMapper();
      Map<String, Object> data = mapper.readValue(new File("output/results/512_768bit_targets.json"), Map.class);
